  ...
  return (
    <div id='main-about-experts' className='w-[75%] m-auto grid grid-cols-2'>
      ...
      <div id='about-experts-right' className='m-auto text-center'>
        ...
        <a href='/readmore' className='text-[1.5rem] font-semibold text-[#3629b0] flex items-center justify-center'><TiArrowForward className='mr-[.3rem]'/>Read more about them!</a>
      </div>
    </div>
  )
}
