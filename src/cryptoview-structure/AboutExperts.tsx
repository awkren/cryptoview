  ...
  return (
    <div id='main-about-experts' className='w-[75%] m-auto grid grid-cols-2'>
      ...
      <div id='about-experts-right' className='m-auto text-center'>
        <p className='text-[3rem] font-semibold'>We work with the best</p>
        ...
        <p className='flex gap-[3rem] text-[3.2rem] justify-center mb-[1rem]'><SiCnn/><SiBbc/><SiThewashingtonpost/><SiNewyorktimes/></p>
