    ...
    <div id='how-it-works-div' className='mt-[3rem]'>
      ...
      <div id='how-grid' className='flex flex-col w-[80%] m-auto text-center'>
        ...
        <div id='how-bot' className='mt-[2rem] m-auto'>
          <p className='text-[1.3rem] font-semibold text-[#3629b0] uppercase flex flex-row items-center'><TiArrowForward className='mr-[5px]'/><a href='/howitworks'>Read more</a></p>
        </div>
      </div>
    </div>
  )
